...
Ext.Loader.addClassPathMappings({
  ...
  "MobileScoreBoard": "app",
  "MobileScoreBoard.util.Proxy": "app/util/MobileTicketProxy.js",
  "MobileScoreBoard.view.dataview.CardDataView": "app/view/dataview/CardDataview.js",
  "MobileScoreBoard.view.dataview.FormDetailDataView": "app/view/dataview/FormDetailDataview.js",
  "MobileTicket_OLD": "app"
});
Ext.ClassManager.addNameAlternateMappings({
  ...
  "MobileScoreBoard.controller.About": [],
  "MobileScoreBoard.controller.List3": [],
  "MobileScoreBoard.controller.Loans": [],
  "MobileScoreBoard.controller.Speakers": [],
  "MobileScoreBoard.controller.ticketSL": [],
  "MobileScoreBoard.model.Loan": [],
  "MobileScoreBoard.model.SessionModel": [],
  "MobileScoreBoard.model.Speaker": [],
  "MobileScoreBoard.model.TicketModel": [],
  "MobileScoreBoard.store.List3": [],
  "MobileScoreBoard.store.Loans": [],
  "MobileScoreBoard.store.MTSessionStore": [],
  "MobileScoreBoard.store.Speakers": [],
  "MobileScoreBoard.store.TicketStore": [],
  "MobileScoreBoard.util.Config": [],
  "MobileScoreBoard.util.CustomReader": [],
  "MobileScoreBoard.util.KivaProxy": [],
  "MobileScoreBoard.util.Proxy": [],
  "MobileScoreBoard.view.Main": [],
  "MobileScoreBoard.view.about.AboutCard": [],
  "MobileScoreBoard.view.about.AboutItem": [],
  "MobileScoreBoard.view.about.Card": [],
  "MobileScoreBoard.view.about.HtmlPage": [],
  "MobileScoreBoard.view.about.List": [],
  "MobileScoreBoard.view.about.Main": [],
  "MobileScoreBoard.view.about.MainAbout": [],
  "MobileScoreBoard.view.about.VideoList": [],
  "MobileScoreBoard.view.dataview.Card": [],
  "MobileScoreBoard.view.dataview.CardDataView": [],
  "MobileScoreBoard.view.dataview.FormDetailDataView": [],
  "MobileScoreBoard.view.login.LoginCard": [],
  "MobileScoreBoard.view.login.LoginItem": [],
  "MobileScoreBoard.view.main.MainCard": [],
  "MobileScoreBoard.view.main.MainItem": [],
  "MobileScoreBoard.view.phonegap.PhonegapBeepCard": [],
  "MobileScoreBoard.view.phonegap.PhonegapCard": [],
  "MobileScoreBoard.view.phonegap.PhonegapInAppBrowserCard": [],
  "MobileScoreBoard.view.phonegap.PhonegapPhotoCard": [],
  "MobileScoreBoard.view.phonegap.PhonegapVibrateCard": [],
  "MobileScoreBoard.view.scoreboard.ScoreboardCard": [],
  "MobileScoreBoard.view.speaker.Card": [],
  "MobileScoreBoard.view.speaker.Detail": [],
  "MobileScoreBoard.view.speaker.Info": [],
  "MobileScoreBoard.view.speaker.List": [],
  "MobileScoreBoard.view.speaker.List2": [],
  "MobileScoreBoard.view.test.TestCard": [],
  "MobileScoreBoard.view.test.TestList": [],
  "MobileScoreBoard.view.ticket.Card": [],
  "MobileScoreBoard.view.ticket.List3": [],
  "MobileScoreBoard.view.ticketSL.Card": [],
  "MobileScoreBoard.view.ticketSL.FormDetail": [],
  "MobileScoreBoard.view.ticketSL.FormLookup": [],
  "MobileScoreBoard.view.ticketSL.FormPanel": [],
  "MobileScoreBoard.view.ticketSL.Info": [],
  "MobileScoreBoard.view.ticketSL.List": [],
  "MobileScoreBoard.view.ticketSL.Login": [],
  "MobileScoreBoard.view.ticketSL.details.InfoDetail": [],
  "MobileScoreBoard.view.ticketSL.details.MainDetail": [],
  "MobileTicket_OLD.util.Proxy": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "MobileScoreBoard.view.dataview.FormDetailDataView": [
    "widget.dataviewFormDetailDataView"
  ],
  "MobileScoreBoard.view.login.LoginCard": [
    "widget.loginCardContainer"
  ],
  "MobileScoreBoard.view.login.LoginItem": [
    "widget.loginItem"
  ],
  ...
  "MobileScoreBoard.view.phonegap.PhonegapBeepCard": [
    "widget.phonegapBeepCard"
  ],
  "MobileScoreBoard.view.phonegap.PhonegapCard": [
    "widget.phonegapCardContainer"
  ],
  "MobileScoreBoard.view.phonegap.PhonegapInAppBrowserCard": [
    "widget.phonegapInAppBrowserCard"
  ],
  "MobileScoreBoard.view.phonegap.PhonegapPhotoCard": [
    "widget.phonegapPhotoCard"
  ],
  "MobileScoreBoard.view.phonegap.PhonegapVibrateCard": [
    "widget.phonegapVibrateCard"
  ],
  "MobileScoreBoard.view.scoreboard.ScoreboardCard": [
    "widget.scoreboardCard"
  ],
  "MobileScoreBoard.view.speaker.Card": [
  ...
  "MobileScoreBoard.view.ticketSL.FormDetail": [
    "widget.ticketSLFormDetail"
  ],
  "MobileScoreBoard.view.ticketSL.FormLookup": [
    "widget.ticketSLFormLookup"
  ],
  "MobileScoreBoard.view.ticketSL.FormPanel": [
    "widget.ticketSLFormPanel"
  ],
  "MobileScoreBoard.view.ticketSL.Info": [
    "widget.ticketSLInfo"
  ],
