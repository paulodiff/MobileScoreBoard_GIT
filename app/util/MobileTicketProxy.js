Ext.define('MobileScoreBoard.util.Proxy', {
		    ...
		    success: function(data) {
		        ...
		        Ext.Array.each(data.proposals, function(proposal) {
		            ...
		            Ext.Array.each(proposal.speakers, function(speaker) {
		                ...
		                speakerModel = Ext.create('MobileScoreBoard.model.Speaker', speaker);
		        ...
		        MobileScoreBoard.sessionDays = Ext.Array.sort(Ext.Object.getValues(sessionDays), function(a, b) {
